...
import img1 from "../../Things/photos/ava-1.jpg";
import img2 from "../../Things/photos/ava-2.jpg";
import img3 from "../../Things/photos/ava-3.jpg";
import img4 from "../../Things/photos/ava-4.jpg";
    ...
    <Slider {...settings}>
      <div className="testimonial py-4 px-3">
        ...
        <div className="mt-3 d-flex align-items-center gap-4">
          ...
          <div className="">
            <h6 className="mb-0 mt-3">Akshat</h6>
      ...
      <div className="testimonial py-4 px-3">
        ...
        <div className="mt-3 d-flex align-items-center gap-4">
          ...
          <div className="">
            <h6 className="md-0 mt-3">Akshat</h6>
            <p className="section__description">customer</p>
          </div>
        </div>
      </div>
